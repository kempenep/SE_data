...
v = pj.JimVect(vfn)
extracted = pj.geometry.extract(v, jim, rule=['mean', 'stdev', 'min'], output='/vsimem/temp.sqlite', oformat='SQLite', srcnodata = -1)
...
# extracted = pj.geometry.extract(v, jim, rule=['mean', 'stdev', 'min'], output='/vsimem/point_buf.sqlite', oformat='SQLite', srcnodata = -1, buffer = 2)
# print(extracted.dict())
